...
- Seed data, detailed learning comments, Day 1 assignment materials, wiki, and end-user Help Center.
...
├── Day1/                   Complete Day 1 online assignment and code lab
├── docs/help-center/       Task-based end-user instructions
...
```bash
cd /path/to/codes-training-center
...
- [End-user Help Center](docs/help-center/user-guide.md)
- [Day 1 assignment](Day1/README.md)
