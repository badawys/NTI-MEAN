...
const translations = {
  en: {
    ...
    level: 'Level', fullCapacity: 'Total capacity', remainingSeats: 'Remaining seats', isPublished: 'Publish now', save: 'Save course', archive: 'Archive', unarchive: 'Unarchive', draft: 'Draft', archived: 'Archived',
    ...
    profileTitle: 'Your profile', profileIntro: 'Keep your account details accurate and your password private.',
    accountDetails: 'Account details', saveChanges: 'Save changes', profileSaved: 'Profile details updated.',
    passwordSecurity: 'Password security', currentPassword: 'Current password', newPassword: 'New password',
    passwordHint: 'Use at least 8 characters.', changePassword: 'Change password', passwordChanged: 'Password changed successfully.',
  ...
  ar: {
    ...
    summaryAr: 'الوصف بالعربية', duration: 'المدة (بالساعات)', capacity: 'السعة', level: 'المستوى', fullCapacity: 'السعة الكاملة', remainingSeats: 'المقاعد المتبقية', isPublished: 'النشر الآن',
    save: 'حفظ الدورة', archive: 'أرشفة', unarchive: 'إلغاء الأرشفة', draft: 'مسودة', archived: 'مؤرشفة', student: 'الطالب', course: 'الدورة',
    ...
    profileTitle: 'ملفك الشخصي', profileIntro: 'حافظ على دقة بيانات حسابك وخصوصية كلمة المرور.',
    accountDetails: 'بيانات الحساب', saveChanges: 'حفظ التغييرات', profileSaved: 'تم تحديث بيانات الملف الشخصي.',
    passwordSecurity: 'أمان كلمة المرور', currentPassword: 'كلمة المرور الحالية', newPassword: 'كلمة المرور الجديدة',
    passwordHint: 'استخدم 8 أحرف على الأقل.', changePassword: 'تغيير كلمة المرور', passwordChanged: 'تم تغيير كلمة المرور بنجاح.',
